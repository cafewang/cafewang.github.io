...
every node/.style={minimum size=1cm, \DrawFlag, outer sep=0, inner sep=0, line width=\d, font=\large\bfseries},
circle node/.style={circle, draw, minimum size=1cm, line width=1pt, font=\large\bfseries},
selected node/.style={circle, draw, fill=ashgrey, minimum size=1cm, line width=1pt, font=\large\bfseries},
]

\matrix (m0) [nodes in empty cells,column sep=35pt, row sep=20pt,]
{
...
\matrix (m1) [nodes in empty cells,column sep=35pt, row sep=20pt, right=10pt of m0]
{
...
\matrix (m2) [nodes in empty cells,column sep=35pt, row sep=20pt, right=30pt of m1]
{
...
\matrix (m3) [nodes in empty cells,column sep=35pt, row sep=20pt, right=30pt of m2]
{
...
circle node/.style={circle, draw, minimum size=1cm, line width=1pt, font=\large\bfseries},
selected node/.style={circle, draw, fill=ashgrey, minimum size=1cm, line width=1pt, font=\large\bfseries},
rec node/.style={rectangle, draw, minimum size=1cm, line width=1pt, font=\large\bfseries},
yellow node/.style={rectangle, draw, fill=almond, minimum size=1cm, line width=1pt, font=\large\bfseries},
]


\matrix (m0) [nodes in empty cells,column sep=10pt, row sep=20pt,]
{
\node[circle node] (a0) {2}; &  &\node[selected node] (b0) {0}; & \\
& \node[circle node] (c0) {1}; & & \node[circle node] (d0) {3}; \\
};

\matrix (t0) [nodes in empty cells,column sep=-1pt, row sep=-1pt, left=10pt of m0]
{
\node {distTo}; \\
...
\matrix (t1) [nodes in empty cells,column sep=-1pt, row sep=-1pt, right=10pt of m0]
{
\node {distTo}; \\
\node[rec node] {$0_0$}; \\
\node[yellow node] {$2_1$}; \\
...
\matrix (m1) [nodes in empty cells,column sep=10pt, row sep=20pt, right=10pt of t1]
{
...
\matrix (t2) [nodes in empty cells,column sep=-1pt, row sep=-1pt, right=10pt of m1]
{
\node {distTo}; \\
\node[rec node] {$0_0$}; \\
\node[rec node] {$2_1$}; \\
...
\matrix (m2) [nodes in empty cells,column sep=10pt, row sep=20pt, below=60pt of m0]
{
\node[selected node] (a2) {2}; &  &\node[selected node] (b2) {0}; & \\
& \node[selected node] (c2) {1}; & & \node[circle node] (d2) {3}; \\
};

\matrix (t3) [nodes in empty cells,column sep=-1pt, row sep=-1pt, right=10pt of m2]
{
\node {distTo}; \\
\node[rec node] {$0_0$}; \\
\node[rec node] {$2_1$}; \\
...
\matrix (m3) [nodes in empty cells,column sep=10pt, row sep=20pt, right=10pt of t3]
{
\node[selected node] (a3) {2}; &  &\node[selected node] (b3) {0}; & \\
& \node[selected node] (c3) {1}; & & \node[selected node] (d3) {3}; \\
};

\matrix (t4) [nodes in empty cells,column sep=-1pt, row sep=-1pt, right=10pt of m3]
{
\node {distTo}; \\
\node[rec node] {$0_0$}; \\
\node[rec node] {$2_1$}; \\
